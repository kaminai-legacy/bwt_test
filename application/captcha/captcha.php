...
class Captcha {
    ...
    static public function html($added_attributes, $width=170, $height=60)
	{
        $dir = __DIR__ . '/fonts/';
		...
		$image=self::deformation($image, $width, $height);
	...
	static private function deformation($input_image, $width, $height){
